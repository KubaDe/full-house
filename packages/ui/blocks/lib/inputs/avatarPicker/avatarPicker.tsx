...
import { type Avatar, type partsOptions, defaultAvatar } from "@repo/schemas";
  ...
  ({ onChange, defaultValue = defaultAvatar, value }, ref) => {
    ...
    return (
      ...
      >
        ...
        <ControlRow
          onClick={(direction) =>
            handleRowClick({ direction, part: "accessory" })
          }
        ...
        <ControlRow
          onClick={(direction) =>
            handleRowClick({ direction, part: "facialHair" })
          }
