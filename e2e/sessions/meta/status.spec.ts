...
test.describe.serial("Show user status", () => {
  test("User A sees all users as absent", async ({ participantA, participantB, participantC, room }) => {
  ...
  test("User B joins the room", async ({ participantA, participantB, participantC, room }) => {
    await participantA.page.goto(`/room/${room.stateHelpers.roomId}`);
    const statusBForA = participantA.page
      .getByTestId(`participantList.${participantB.stateHelpers.userId}`)
      .getByTestId("statusDot");
  ...
  test("User C joins the room", async ({ participantA, participantB, participantC, room }) => {
    await participantA.page.goto(`/room/${room.stateHelpers.roomId}`);
    const statusBForA = participantA.page
      .getByTestId(`participantList.${participantB.stateHelpers.userId}`)
      .getByTestId("statusDot");
