...
export const NoMetaSessionModal = ({ roomId }: NoMetaSessionModalModalProps) => {
  const utils = api.useUtils();
  const { replace } = useRouter();

  const { mutateAsync: createSession, isPending } = api.session.createSessionMutation.useMutation({
