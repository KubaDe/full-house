...
describe("MessagesGroupContent", () => {
  ...
  it("should render user name correctly", async () => {
    ...
    await waitFor(() =>
      expect(screen.getByTestId("chat.messageGroup.sender")).toHaveTextContent("John Smith"),
    );
  });
  ...
  it("should render message when user is not found", async () => {
    ...
    await waitFor(() => expect(screen.getByTestId("chat.messageGroup.sender")).toHaveTextContent("Unknown"));
  });
  ...
  it("should render single message correctly", async () => {
    ...
    expect(screen.getByTestId("chat.message.content")).toHaveTextContent("Single message");
  });
