...
describe("groupConsecutiveMessages", () => {
  ...
  it("should handle a single message correctly", () => {
    const messages = [{ id: "1", userId: "user1", payload: { message: "Hello" } }];
    ...
    const expected: MessagesGroup[] = [
      {
        userId: "user1",
        id: "1",
        messages: [{ id: "1", userId: "user1", payload: { message: "Message 1" } }],
      },
      {
        userId: "user2",
        id: "2",
        messages: [{ id: "2", userId: "user2", payload: { message: "Message 2" } }],
      },
      {
        userId: "user1",
        id: "3",
        messages: [{ id: "3", userId: "user1", payload: { message: "Message 3" } }],
      },
    ];
