...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/uiKit/card";
import { Badge } from "@/components/uiKit/badge";

type PendingInvitationsCardProps = {
  roomId: string;
};
export const PendingInvitationsCard = ({ roomId }: PendingInvitationsCardProps) => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Users that are already invited to this room.</CardDescription>
      </CardHeader>
      <CardContent>
        <ul className="flex w-full flex-wrap gap-1" aria-label="invitations list">
